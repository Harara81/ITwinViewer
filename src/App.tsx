...
import { ScreenViewport, ViewState, ViewState3d } from "@itwin/core-frontend";
...
import { RoomsWidgetProvider } from "./RoomsWidget";
/*
"scripts": {
...
const App: React.FC = () => {
  ...
  function sayHello() {
    ...
    if (firstVP && firstVP.view.isSpatialView()) {
      const e = firstVP.view.getEyePoint();
      const t = firstVP.view.getTargetPoint();
      const l = firstVP.view.getLensAngle();
      console.log(
        e.toArray().toString() +
          ", " +
          t.toArray().toString() +
